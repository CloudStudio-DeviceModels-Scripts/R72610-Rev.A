...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  var ntu = endpoints.addEndpoint("2", "NTU", endpointType.genericSensor);
        ntu.variableTypeId = 1274;
   endpoints.addEndpoint("3", "Temperature sensor", endpointType.temperatureSensor);
